...
interface InitialCurrentPhotoComparisonProps {
...
export function InitialCurrentPhotoComparison({
  patient,
  open,
  onOpenChange
}: InitialCurrentPhotoComparisonProps) {
    ...
    if (open && patient) {
      ...
      try {
        ...
        const currentPhotosData: PhotoSet = {
          frente: (patient as any).foto_atual_frente || undefined,
          lado: (patient as any).foto_atual_lado || undefined,
          lado_2: (patient as any).foto_atual_lado_2 || undefined,
          costas: (patient as any).foto_atual_costas || undefined
        };
        setCurrentPhotos(currentPhotosData);
        setCurrentDate((patient as any).data_fotos_atuais 
          ? new Date((patient as any).data_fotos_atuais).toLocaleDateString('pt-BR')
          : 'Dados Atuais');
