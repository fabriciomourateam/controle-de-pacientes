...
export const RichTextEditor = React.forwardRef<HTMLDivElement, RichTextEditorProps>(
  ({ value, onChange, placeholder, className = '', resizable = false }, externalRef) => {
    const internalEditorRef = useRef<HTMLDivElement>(null);

    // Compatibilidade com ref externa (ex: react-hook-form)
    const editorRef = (externalRef as React.RefObject<HTMLDivElement>) || internalEditorRef;
