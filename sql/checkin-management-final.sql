-- Sistema de Gestão de Check-ins - Versão Final
-- Execute APÓS adicionar as colunas com add-missing-checkin-columns.sql
...
-- PARTE 9: Função para atualizar contador de notas
...
-- PARTE 13: Criar view para facilitar consultas
...
-- PARTE 14: Inicializar contador de notas para check-ins existentes
UPDATE checkin SET notes_count = 0 WHERE notes_count IS NULL;

-- PARTE 15: Conceder permissões necessárias
