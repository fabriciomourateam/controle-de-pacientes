-- Sistema de Conteúdo Personalizado para Relatórios de Renovação (CORRIGIDO)
...
-- Política para membros da equipe acessarem conteúdos do owner (CORRIGIDA)
...
-- Política para membros da equipe criarem conteúdos para o owner (CORRIGIDA)
...
-- Política para membros da equipe atualizarem conteúdos do owner (CORRIGIDA)
