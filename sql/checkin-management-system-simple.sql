-- Sistema de Gestão de Check-ins - Versão Simples
-- Execute este SQL no Supabase SQL Editor em partes

-- PARTE 1: Adicionar colunas à tabela checkin
-- Execute uma por vez se necessário
...
-- PARTE 3: Criar trigger para updated_at na tabela checkin
...
-- PARTE 4: Criar tabela para anotações dos check-ins
...
-- PARTE 6: Criar trigger para updated_at na tabela checkin_notes
...
-- PARTE 7: Função para adquirir lock em um check-in
...
-- PARTE 8: Função para liberar lock de um check-in
...
-- PARTE 9: Função para limpar locks expirados
...
-- PARTE 10: Função para obter membros da equipe disponíveis
...
-- PARTE 11: Função para atualizar contador de notas
...
-- PARTE 12: Criar triggers para contador de notas
...
-- PARTE 13: Habilitar RLS na tabela checkin_notes
ALTER TABLE checkin_notes ENABLE ROW LEVEL SECURITY;

-- PARTE 14: Políticas RLS para checkin_notes
...
-- PARTE 15: Criar view para facilitar consultas
...
-- PARTE 16: Atualizar contador de notas para check-ins existentes
...
-- PARTE 17: Conceder permissões necessárias
