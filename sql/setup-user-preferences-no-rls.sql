-- Script para configurar user_preferences SEM RLS (consistente com outras tabelas)
...
-- 4. DESABILITAR RLS (consistente com outras tabelas do projeto)
...
COMMENT ON TABLE user_preferences IS 'Tabela para armazenar preferências do usuário incluindo notificações lidas (RLS DESABILITADO)';
...
SELECT 
  'user_preferences table configured successfully (RLS DISABLED)' as status,
