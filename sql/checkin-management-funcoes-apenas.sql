-- Sistema de Gestão de Check-ins - Apenas Funções e Tabelas
-- Este script funciona independente do estado atual da tabela checkin
...
-- PARTE 9: Habilitar RLS na tabela checkin_notes
ALTER TABLE checkin_notes ENABLE ROW LEVEL SECURITY;

-- PARTE 10: Políticas RLS para checkin_notes
...
-- PARTE 11: Conceder permissões necessárias
...
-- Finalizado!
SELECT 'Funções do Sistema de Gestão de Check-ins instaladas com sucesso!' as resultado;