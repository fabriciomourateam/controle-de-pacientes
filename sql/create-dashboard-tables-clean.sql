-- =====================================================
-- CRIAÇÃO DAS TABELAS PARA DASHBOARD DE MÉTRICAS - VERSÃO LIMPA
-- =====================================================

-- Primeiro, remover todas as views e tabelas existentes (se existirem)
...
-- Tentar remover como tabela e view
